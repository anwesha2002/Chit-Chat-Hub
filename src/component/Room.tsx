...
export function Room({id , room_name, createdBy} : RoomType | DocumentData){
    const { deleteGroup, setRoomId } = UseRoom()
    ...
    return(
        <>
            <Card id="chatgroup" onClick={()=>handleRoomClick(id)}  className=" p-5 rounded-full m-4 bg-gray-400 flex justify-center items-center shadow-gray-400-xl  border-2 border-b-blue-500 border-t-blue-500 bg-base-false w-full" compact bordered>
